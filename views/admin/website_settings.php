        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="social">
                    ...
                    <div class="form-group">
                        <label><i class="fab fa-fw fa-facebook"></i> <?= $language->admin_website_settings->input->facebook ?></label>
                        <input type="text" name="facebook" class="form-control" value="<?= $settings->facebook ?>" />
                    </div>

                    <div class="form-group">
                        <label><i class="fab fa-fw fa-twitter"></i> <?= $language->admin_website_settings->input->twitter ?></label>
                        <input type="text" name="twitter" class="form-control" value="<?= $settings->twitter ?>" />
                    </div>

                    <div class="form-group">
                        <label><i class="fab fa-fw fa-instagram"></i> <?= $language->admin_website_settings->input->instagram ?></label>
                        <input type="text" name="instagram" class="form-control" value="<?= $settings->instagram ?>" />
                    </div>

                    <div class="form-group">
                        <label><i class="fab fa-fw fa-youtube"></i> <?= $language->admin_website_settings->input->youtube ?></label>
                ...
                <div class="tab-pane fade" id="sources">
                    ...
                    foreach($plugins->plugins as $plugin_identifier => $value) {
                        ...
                        if($plugins->exists_and_active($plugin_identifier)) {
                            require_once $plugins->require($plugin_identifier, 'views/admin/website_settings');
                        }
                ...
                <div class="tab-pane fade" id="cron">
                    ...
                    <h5>Info</h5>
                    <p>If you are going to set up the cron to run <strong>once every minute</strong> then you will be able to query about <strong><span id="queries_per_day"><?= $settings->cron_queries * 1440 ?></span> * {active_plugins_count} queries per day</strong>. Change the Cron Queries if you want to get other approximations.</p>
                </div>
