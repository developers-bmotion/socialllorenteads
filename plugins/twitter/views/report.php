...
<div class="margin-bottom-6">
    ...
    <div class="margin-bottom-6">
        <div class="d-flex justify-content-between">
            ...
            <a href="<?= csv_link_exporter(csv_exporter($logs, ['id', 'twitter_user_id'])) ?>" download="report.csv" target="_blank" class="align-self-start btn btn-light"><i class="fa fa-fw fa-file-csv"></i> <?= $language->global->export_csv ?></a>
        </div>
        ...
        <table class="table table-responsive-md">
            ...
            <?php foreach($tweets_result as $tweet): ?>
                <tr>
                    ...
                    <td><i class="fa fa-fw fa-retweet views-color"></i> <?= nr($tweet->retweets) ?></td>
                    <td><i class="fa fa-fw fa-heart like-color"></i> <?= nr($tweet->likes) ?></td>
                    <td><?= $tweet->source ?></td>
