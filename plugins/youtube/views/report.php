<?php defined('ALTUMCODE') || die() ?>
        ...
        <div class="row">
            <div class="col-2">
                <h5>
                    ...
                    <span><i class="fa fa-fw fa-flag text-muted"></i></span>
                </h5>
            </div>
        ...
        <div class="row">
            <div class="col-2">
                <h5>
                    ...
                    <span><i class="fa fa-fw fa-calendar text-muted"></i></span>
                </h5>
            </div>
    ...
    <div class="margin-bottom-6">
        <div class="d-flex justify-content-between">
            ...
            <a href="<?= csv_link_exporter(csv_exporter($logs, ['id', 'youtube_user_id'])) ?>" download="report.csv" target="_blank" class="align-self-start btn btn-light"><i class="fa fa-fw fa-file-csv"></i> <?= $language->global->export_csv ?></a>
        </div>
        ...
        <table class="table table-responsive-md">
            ...
            <?php foreach($videos_results as $video): ?>
                <tr>
                    ...
                    <td>
                        <i class="fa fa-fw fa-eye views-color"></i> <?= nr($video->views) ?>
                    </td>
                    <td>
                        <i class="fa fa-fw fa-heart like-color"></i> <?= nr($video->likes) ?>
                    </td>
                    <td>
                        <i class="fa fa-fw fa-thumbs-down"></i> <?= nr($video->dislikes) ?>
                    </td>
                    <td>
                        <i class="fa fa-fw fa-comments"></i> <?= nr($video->comments) ?>
                    </td>
                </tr>
            <?php endforeach ?>
            </tbody>
