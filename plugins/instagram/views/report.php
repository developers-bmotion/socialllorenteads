<?php defined('ALTUMCODE') || die() ?>
        ...
        <div class="row">
            <div class="col">
                <h5>
                    ...
                    <span data-toggle="tooltip" title="<?= $language->instagram->report->display->engagement_rate_help ?>"><i class="fa fa-fw fa-question-circle text-muted"></i></span>
                </h5>
            </div>
        ...
        <div class="row">
            <div class="col">
                <h5>
                    ...
                    <span data-toggle="tooltip" title="<?= sprintf($language->instagram->report->display->average_likes_help, $settings->instagram_calculator_media_count) ?>"> <i class="fa fa-fw fa-heart like-color"></i></span>
                </h5>
            </div>
        ...
        <div class="row">
            <div class="col">
                <h5>
                    ...
                    <span data-toggle="tooltip" title="<?= sprintf($language->instagram->report->display->average_comments_help, $settings->instagram_calculator_media_count) ?>"><i class="fa fa-fw fa-comments text-muted"></i></span>
                </h5>
            </div>
    ...
    <div class="margin-bottom-6">
        <div class="d-flex justify-content-between">
            ...
            <a href="<?= csv_link_exporter(csv_exporter($logs, ['id', 'instagram_user_id'])) ?>" download="report.csv" target="_blank" class="align-self-start btn btn-light"><i class="fa fa-fw fa-file-csv"></i> <?= $language->global->export_csv ?></a>
        </div>
        ...
        <table class="table table-responsive-md">
            ...
            <tr>
                <th>
                    ...
                    <span data-toggle="tooltip" title="<?= sprintf($language->report->display->date_help, $language->global->date->datetime_format) ?>"><i class="fa fa-fw fa-question-circle text-muted"></i></span>
                </th>
                <th></th>
                    ...
                    <tr>
                        <td>
                            <a href="<?= $media->media_url ?>" target="_blank" data-toggle="tooltip" title="<?= $language->instagram->report->display->media_type->{strtolower($media->type)} ?>">
                                ...
                                switch($media->type) {
                                    case 'IMAGE':
                                        echo '<i class="fa fa-fw fa-image"></i>';
                                        break;

                                    case 'VIDEO':
                                        echo '<i class="fa fa-fw fa-video"></i>';
                                        break;

                                    case 'SIDECAR':
                                        echo '<i class="fa fa-fw fa-images"></i>';
                                        break;
                        ...
                        <td><img src="<?= $media->media_image_url ?>" onerror="$(this).attr('src', ($(this).data('failover')))" data-failover="<?= $settings->url . ASSETS_ROUTE ?>images/default_avatar.png" class="img-responsive rounded-circle instagram-avatar-small" /></td>
